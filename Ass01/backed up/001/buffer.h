...
it is for COVER PAGE ???
* File Name: buffer.h
* Author: Seongyeop Jeong
* Assignment : 1
* Date: 2 October 2018
* Contents: Preprocessor directives, type declarations which is necessary for the buffer implementation
*			This header file is not for implement
...
* Contents		: b_allocate, b_addc, b_clear, b_free, b_isfull, b_limit, b_capacity, b_mark,
